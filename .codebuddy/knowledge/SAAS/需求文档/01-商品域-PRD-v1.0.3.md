# 商品域 产品需求文档 PRD V1.0.3

> **文档类型**：业务域产品需求文档（PRD）
> **所属系统**：九天 SAAS 电商平台
> **业务域**：商品域（D01）
> **文档版本**：V1.0.3（整合 V1.0.2 ~ V1.0.9 商品域全部迭代）
> **编制日期**：2026-07-16
> **数据来源**：Axure 原型 V1.0.2 ~ V1.0.9、`商品V1.0.0.md`、`SAAS系统功能详细清单.xlsx`
> **追溯链**：UC-PRD → FN-PRD → PG-PRD → MD-PRD（模块设计）→ SC-PRD（场景）→ BG-09（业务目标）→ BO-09（业务对象）
...
| 版本 | 日期 | 变更内容 | 编制人 |
|------|------|----------|--------|
| V1.0.2 | 2026-05-15 | 初始版本：商品管理列表（按商品/按SKU双视图）、品类管理（运营后台）、类目参数/规格、添加/编辑商品、商品图片/视频、门店商品、直播商品、设置门店 | 产品团队 |
| V1.0.3 | 2026-05-25 | 重大变更：新增商品审核流程、状态管理、设置供应商、设置佣金、运费设置、移除设置门店操作、添加/编辑商品增强（划线价/按单限购/发货模式/采购价区间/双向同步）、门店商品调整、供应商商品、商品数据 | 产品团队 |
...
**数据范围**：R（品类列表）/ W（新建/编辑/启用/禁用/设置特殊许可证）
...
**数据范围**：R（商品列表）/ W（编辑/复制/审核/上下架/设置供应商/设置佣金）
