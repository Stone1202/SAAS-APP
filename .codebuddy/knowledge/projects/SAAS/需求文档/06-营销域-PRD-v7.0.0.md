# 营销域 产品需求文档 PRD V7.0.0

> **业务域**：营销域（D06） | **版本**：V7.0.0 | **日期**：2026-07-21
...
| exchange_limit | Integer | 兑换上限（次）🟡【隐式挖掘·依据:核销优惠券字段"兑换上限（次）"】 |
...
flowchart LR
    ...
    DEDUCT -->|产生| FROZEN[冻结积分]
    FROZEN -->|触发| AVAILABLE[可用积分]
